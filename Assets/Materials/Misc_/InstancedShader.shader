	...
	SubShader { 
		...
		Pass {
			...
			Varyings vert(Attributes IN, uint instanceID: SV_InstanceID) {
                ...
                OUT.positionCS = mul(UNITY_MATRIX_P,
				...
				* float4(1, 1, 1.0, 1.0));
                ...
                // If instancing on (it should be) assign per-instance color.
                    ...
                    IN.color = _Colors[instanceID];
                #endif
                OUT.color = IN.color; //tex2Dlod(sampler_MyGrab, positionInputs.positionCS);
			...
			SurfaceData InitializeSurfaceData(Varyings IN){
				...
				surfaceData.alpha = Alpha(albedoAlpha.a, IN.color, _Cutoff);
				surfaceData.albedo = albedoAlpha.rgb * IN.color.rgb * IN.color.rgb;
        ...
        //UNCOMMENT THIS PASS TO ENABLE SHADOW-CASTING
		// Pass {
		// 	Name "ShadowCaster"
